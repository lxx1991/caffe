...
file_net = fullfile(dir_model, 'RIS_weak_test.prototxt');
file_weight = fullfile(dir_model, 'model','weak2_iter_60000.caffemodel');
...
%     name_list{idx} = '2008_001648';
    ...
    if (exist('show', 'var') && length(tmp) > 1)
        show = 5;
        subplot(221);
        imshow(img);
%         subplot(222);
